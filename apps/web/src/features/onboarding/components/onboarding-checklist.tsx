    ...
    return (
      <aside aria-label="Getting started" className={cn(ANCHOR_COLLAPSED, ENTER)}>
        <button
          ...
          aria-expanded={false}
          className="inline-flex cursor-pointer items-center gap-2.5 rounded-full border border-hairline bg-paper py-2 pl-2.5 pr-3.5 shadow-card transition-colors hover:bg-cloud focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
        >
