...
| 3   | AI experience          | Partial   | Persisted conversation with a model-written reply grounded in the enhanced prompt, editor assistant, prompt library (`prompts/`), recipes as templates, chunk versioning. No playground or saved-prompt UI.                                                                                                                                             |
