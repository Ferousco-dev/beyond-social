...
| --- | ---------------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | Product                | Partial   | Landing, pricing, dashboard, persisted chat with a real assistant, photo upload, an editor whose timeline autosaves with conflict detection, settings (account, connections, billing), credits, usage, teams. No per-seat management UI.                                                                                                                |
...
| 3   | AI experience          | Partial   | Persisted conversation with intent routing (create, adjust, ask), refinement that edits the previous direction rather than re-inventing it, parameter extraction, a model-written reply, editor assistant, prompt library, recipes, chunk versioning. No playground.                                                                                    |
