...
| 11  | API platform           | Partial     | Versioned REST at `/api/v1` with hashed API keys, bearer auth failing closed, and in-app key management. No SDKs, outbound webhooks, or OpenAPI spec.                                                                                                         |
